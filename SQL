...
-- create table - EXAM
CREATE TABLE EXAM(TEST# VARCHAR(10) NOT NULL,TEST_DATE DATE,START_TIME DATE,DURATION VARCHAR(8));

-- create table - QUESTION
CREATE TABLE QUESTION(TEST# VARCHAR(10) NOT NULL, Q# VARCHAR(12) NOT NULL,COMPULSORY VARCHAR(3),TYPE VARCHAR(20),SCORE NUMBER(2,2),Q_CONTENT VARCHAR(100),ANSWER VARCHAR(100));
...
-- create table - SETE
CREATE TABLE SETE(TEST# VARCHAR(10) NOT NULL,YEAR NUMBER(4), SEM VARCHAR(5),TEA_ID VARCHAR(8),C_ID VARCHAR(3));

-- create table - ANSWER
CREATE TABLE ANSWER(Q# VARCHAR(12) NOT NULL,TEST# VARCHAR(10) NOT NULL,STU_ID VARCHAR(8) NOT NULL,STU_ANS VARCHAR(100),STU_SCORE NUMBER(2,2));

-- create table - TAKE
CREATE TABLE TAKE(TEST# VARCHAR(10) NOT NULL,STU_ID VARCHAR(8) NOT NULL,TEST_RESULT NUMBER(3,2), COMMENTS VARCHAR(100));
