...
-- create table - EXAM
CREATE TABLE EXAM(TEST# VARCHAR(11) NOT NULL,TEST_DATE DATE,START_TIME DATE,DURATION VARCHAR(8),PRIMARY KEY (TEST#));
...
INSERT INTO QUESTION VALUES ('201C241101','06','N','long',10,'For collision resolution, explain the difference between Linear Probing and Quadratic Probing.',NULL);
